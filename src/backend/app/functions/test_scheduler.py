...
from gen_sched_input import gen_schedule_repeated, gen_games_round_robin
...
div_a1 = {0: tigers, 1: cardinals, 2: orioles, 3: jays}
div_b1 = {4: dodgers, 5: rangers, 6: astros, 7: angels, 8: rockies}
div_c1 = {9: royals, 10: cubs, 11: padres, 12: white_sox, 13: guardians, 14: braves}
div_d1 = {15: giants, 16: brewers, 17: nationals, 18: rays, 19: marlins, 20: yankees, 21: red_sox}
...
class TestGenGamesRoundRobin(unittest.TestCase):
    ...
    def test_gen_games_round_robin(self, teams, games_per_team):
        games = gen_games_round_robin(teams, games_per_team)
        ...
        for team, count in games_count.items():
            print(count)
            self.assertTrue(count == games_per_team or count == games_per_team + 1, f"{teams[team]["name"]} does not have {games_per_team} games, instead has {count}")

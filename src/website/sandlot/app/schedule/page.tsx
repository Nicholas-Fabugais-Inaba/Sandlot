  ...
  const handleTeamClick = (
    ...
    if (
      ...
      (userRole === "commissioner" ||
        userRole === "role" ||
        (userRole === "team" &&
          (teams.home_id === userTeamId || teams.away_id === userTeamId)))
    ) {
          ...
          <FullCalendar
            ...
            eventContent={(eventInfo) => {
              ...
              const isPastEvent =
                ...
                new Date(eventInfo.event.start) < currDate;
              ...
              return schedType === 0 ? ( // Full Schedule
                ...
                <div className="event-content-grid">
                  ...
                  eventInfo.event.extendedProps.field1?.away ? (
                    <div
                      className={`event-content p-2 rounded-xl ${isPastEvent ? "bg-gray-300 text-gray-600 border-2 border-gray-300" : "bg-red-100 text-red-800"}`}
                    >
                      <div className="event-team font-semibold">
                        {eventInfo.event.extendedProps.field1.home}
                      </div>

...
Oct. 28, 2024 & 1.2 & Removed unused sections in requirements cards. Renamed requirements; enforcing two letter codes.\\
\bottomrule
\end{tabularx}
...
\begin{myreq}
  ...
  \reqrat Sandlot should be accessable to a wide variety of users.
  \reqorig Alex Verity

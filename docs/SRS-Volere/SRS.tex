...
\begin{myreq}
  \threeinline
    ...
    {\reqtype 0}
    {\reqevent 0}
  \reqdesc System must display the season schedule to all users without login.
  \reqrat Users who don't have a login (ie. spectators and umpires) will still
  need to access the schedule, so it should be visible to all.
  \reqorig Alex Verity
  \reqfit The schedule should be viewable without entering a username or
  password.
  \twoinline
    {\reqsatis 3}
    {\reqdissat 3}

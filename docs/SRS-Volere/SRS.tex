...
\begin{myreq}
  \threeinline
    ...
    {\reqtype 0}
    {\reqevent xx}
  \reqdesc All buttons and user input elements should stand out with
  distinctive colours or borders and have feedback. 
  \reqrat User input should be clear to all users so users know where to enter
  inputs.
  \reqorig Alex Verity
  \reqfit Buttons and user input elements must have a minimum size of 44x44
  pixels, maintain at least a 3:1 contrast ratio with the background, and
  include distinct visual feedback (e.g., color change or shadow) on hover or
...
\begin{myreq}
  ...
  \reqorig Alex Verity
  \reqfit All images made for/by Sandlot must be free of pixelation or
...
\begin{myreq}
  ...
  \reqorig Alex Verity
  \reqfit Navigation options should be consistently placed across pages and
...
\begin{myreq}
  ...
  \reqorig Alex Verity
  \reqfit All interface elements must use consistent fonts, colors, layout
...
\begin{myreq}
  ...
  \reqorig Alex Verity
  \reqfit Body text must have a minimum font size of 16 pixels, a contrast
...
\begin{myreq}
  ...
  \reqorig Alex Verity
  \reqfit The website must achieve a total page load time of under 3 seconds

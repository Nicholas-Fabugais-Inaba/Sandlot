...
\begin{center}
  \begin{tabular}{|m{3cm}|m{8cm}|m{2cm}|}
    ...
    \hline
    Season schedule & Game list & Class\\
    \hline
    Game list & List of Games & Attribute\\
    \hline
    ...
    \hline
    Login details & A user defined username and password & Attribute\\
    \hline
    Commissioner identifier & See Player identifier & Attribute\\
    \hline

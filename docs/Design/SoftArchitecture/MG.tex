...
\begin{description}
  ...
  \item [\refstepcounter{mnum} \mthemnum \label{mLG}:] Account Login Module
  \item [\refstepcounter{mnum} \mthemnum \label{mAC}:] Account Creation Module
  \item [\refstepcounter{mnum} \mthemnum \label{mJR}:] Team Join Request
  Module
  \item [\refstepcounter{mnum} \mthemnum \label{mS}:] Season Scheduler Module
  \item [\refstepcounter{mnum} \mthemnum \label{mSD}:] Schedule Display Module
  \item [\refstepcounter{mnum} \mthemnum \label{mST}:] Standings Display
  Module
  \item [\refstepcounter{mnum} \mthemnum \label{mRS}:] Rescheduler Module
  \item [\refstepcounter{mnum} \mthemnum \label{mAL}:] Alerts Module
  \item [\refstepcounter{mnum} \mthemnum \label{mSS}:] Score Submission Module
  \item [\refstepcounter{mnum} \mthemnum \label{mAD}:] Commissioner Admin
  Module
...
\multirow{9}{0.3\textwidth}{Behaviour-Hiding Module} & Account Login Module\\
& Account Creation Module\\
& Team Join Request Module\\
& Schedule Display Module\\
& Standings Display Module\\
& Rescheduler Module\\
& Alerts Module\\ 
& Commissioner Admin Module\\
...
\subsubsection{Account Login Module (\mref{mLG})}

\begin{description}
\item[Secrets:]The format and structure of the account data.
...
\subsubsection{Account Creation Module (\mref{mAC})}
...
\subsubsection{Team Join Request Module (\mref{mJR})}
...
\subsubsection{Schedule Display Module (\mref{mSD})}
...
\subsubsection{Standings Display Module (\mref{mST})}
...
\subsubsection{Rescheduler Module (\mref{mRS})}
...
\subsubsection{Commissioner Admin Module (\mref{mAD})}

...
\acref{acLogIn} & \mref{mAC}, \mref{mAS}, \mref{mWA}, \mref{mDB}\\
\acref{acSched} & \mref{mS}\\
\acref{acSchedConstraints} & \mref{mSS}\\
\acref{acAvailability} & \mref{mPL}, \mref{mWA}, \mref{mDB}\\
\acref{acSchedConflicts} & \mref{mSS}, \mref{mWA}\\
\acref{acSchedFormat} & \mref{mSS}, \mref{mWA}\\
\acref{acStandFormat} & \mref{mST}, \mref{mWA}\\
\acref{acCreateAccount} & \mref{mPL}, \mref{mTE}, \mref{mWA}, \mref{mDB}\\
\acref{acJoinRequest} & \mref{mPL}, \mref{mTE}, \mref{mWA}\\
\acref{acAdmin} & \mref{mCM}, \mref{mWA}\\
\acref{acAlertSend} & \mref{mAL}, \mref{mWA}\\
\acref{acReschedule} & \mref{mPL}, \mref{mRE}, \mref{mWA}\\
\acref{acAlertReceive} & \mref{mAL}, \mref{mWA}\\
\bottomrule
\end{tabular}
...
Screens are also provided in the appendix.
...
\begin{itemize}
  ...
  \item \textbf{Week 2 (January 20-26)}: Core Module Implementation
    \begin{itemize}
      ...
      \item Create the schedule and standings structure modules (Jung Woo Lee)
  ...
  \item \textbf{Week 3 (January 27-February 2)}: Remaining Modules and Integration
    \begin{itemize}
      ...
      \item Implement web application framework module (Casra Ghazanfari)

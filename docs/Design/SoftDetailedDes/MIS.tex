...
\begin{itemize}
\item transition: The game's score data is updated with the user inputted home
team score, away team score and forfeit data.
\end{itemize}
...
\begin{itemize}
\item transition: The current standings are overwritten with the inputted new
      standings.
\end{itemize}

\noindent overwrite\_game\_score():
\begin{itemize}
\item transition: The inputted game's score is overwritten with the inputted new
      score.
\end{itemize}

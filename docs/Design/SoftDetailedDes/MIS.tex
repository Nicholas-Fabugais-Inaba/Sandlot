...
be played\\
player & $P$ & a player on a team, see Player Module \ref{mPL}\\
team & $T$ & see Team Structure Module \ref{mTS}\\
...
\begin{itemize}
\item transition: The inputted old schedule is replaced with the inputted new
      schedule.
\end{itemize}
...
\noindent send\_alert():
\begin{itemize}
\item transition: An alert is sent to the players in the inputed player list.
\end{itemize}

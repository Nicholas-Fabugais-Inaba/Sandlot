...
be played\\
player & $P$ & a player on a team, uses the Account Record Module
\ref{mAS}\\
...
see Team Record Module \ref{mTS}\\
...
\section{MIS of Account Record Module} \label{mAS}
...
\section{MIS of Team Record Module} \label{mTS}
...
\section{MIS of Schedule Record Module} \label{mSS}

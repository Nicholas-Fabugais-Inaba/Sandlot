...
The system limits itself to the components mentioned before. External APIs that connect
to our system are considered as outside the system boundaries. This would include the
webserver, and weather tracker.

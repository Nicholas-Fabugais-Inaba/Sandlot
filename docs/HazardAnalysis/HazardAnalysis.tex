...
unclear or the user makes an error. & AP-1 AP-2 & Ensure that when assigning a team for a
...
has access to actions they shouldn't use. & Interface lacks security or the user
...
AC-3 & Ensure the alert message is visible and readable.\\
\cline{2-6}
\hline
\end{tabularx}

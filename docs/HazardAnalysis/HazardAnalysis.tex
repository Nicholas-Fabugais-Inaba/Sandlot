...
\hline
\multirow{2}{2cm}{Authentica- tion} & User login information does not match database stored
...
travel to a game at the wrong time. & Misinterpreted information. & 22 &
...
assignment data. & 17 & Ensure that when assigning a team for a user, the

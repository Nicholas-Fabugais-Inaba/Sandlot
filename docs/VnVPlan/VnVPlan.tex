...
Initial State: There are two captains whose team's are scheduled to play a
game in the future.
          
Input: One captain submits a reschedule request.

Output: The other captain recieves a reschedule request.

Test Case Derivation: A captain should recieve a reschedule request if another

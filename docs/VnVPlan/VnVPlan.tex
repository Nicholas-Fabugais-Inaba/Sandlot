...
\begin{enumerate}
  ...
  the user to have have a minimum size of 44x44 pixels, maintain and maintain at 
...
\begin{enumerate}
  ...
  Input/Condition: A user's account is provided permissions that are different from
